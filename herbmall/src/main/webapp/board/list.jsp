...
<%
	...
	//[3] 검색의 경우 - list.jsp 에서 [검색]클릭하면 post방식으로 서브밋됨
	//[4] 페이징 처리의 경우 - listp.jsp에서 [페이지번호]클릭하면 get방식으로 이동
	...
	int totalPage = (int)Math.ceil((float)totalRecord/pageSize); //총페이지 수, 4
...
<div class="divSearch">
   	<form name="frmSearch" method="post" action='list.jsp'> <!-- action 생략해도 자기자신 -->
